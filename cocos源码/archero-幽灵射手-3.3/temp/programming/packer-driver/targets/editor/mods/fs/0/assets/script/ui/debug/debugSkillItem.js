System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("DebugSkillItem", DebugSkillItem = (_dec = ccclass('DebugSkillItem'), _dec2 = property(LabelComponent), _dec3 = property(SpriteComponent), _dec(_class = (_class2 = (_temp = class DebugSkillItem extends Component {
        constructor(...args) {
          super(...args);
