System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("LoadingPanel", LoadingPanel = (_dec = ccclass('LoadingPanel'), _dec2 = property(AnimationComponent), _dec(_class = (_class2 = (_temp = class LoadingPanel extends Component {
        constructor(...args) {
          super(...args);
