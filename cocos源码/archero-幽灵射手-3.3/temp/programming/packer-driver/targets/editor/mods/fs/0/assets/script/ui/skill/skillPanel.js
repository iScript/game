System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("SkillPanel", SkillPanel = (_dec = ccclass('SkillPanel'), _dec2 = property(Node), _dec3 = property(SpriteComponent), _dec4 = property(LabelComponent), _dec(_class = (_class2 = (_temp = class SkillPanel extends Component {
        constructor(...args) {
          super(...args);
        ...
        onBtnRefreshClick() {
          ...
          (_crd && SdkUtil === void 0 ? (_reportPossibleCrUseOfSdkUtil({
            ...
            error: Error()
          }), constant) : constant).SHARE_ID.SKILL_REFRESH, err => {
            if (!err) {
