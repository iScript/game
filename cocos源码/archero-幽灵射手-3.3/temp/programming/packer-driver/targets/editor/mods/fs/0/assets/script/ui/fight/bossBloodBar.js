System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("BossBloodBar", BossBloodBar = (_dec = ccclass('BossBloodBar'), _dec2 = property(UITransformComponent), _dec3 = property(UITransformComponent), _dec(_class = (_class2 = (_temp = class BossBloodBar extends Component {
        constructor(...args) {
          super(...args);
