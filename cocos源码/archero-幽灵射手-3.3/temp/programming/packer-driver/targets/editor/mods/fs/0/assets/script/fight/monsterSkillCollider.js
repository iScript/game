          ...
          if (otherCollider.getGroup() === (_crd && constant === void 0 ? (_reportPossibleCrUseOfconstant({
            ...
            switch (this.colliderName) {
              ...
              case COLLIDER_NAME.FIRE_BALL:
                ...
                scriptSkillCollider = (_this$node$parent2 = this.node.parent) === null || _this$node$parent2 === void 0 ? void 0 : _this$node$parent2.getComponent(_crd && FireBall === void 0 ? (_reportPossibleCrUseOfFireBall({
                  error: Error()
                }), FireBall) : FireBall);
              ...
              case COLLIDER_NAME.TORNADO:
                scriptSkillCollider = (_this$node$parent3 = this.node.parent) === null || _this$node$parent3 === void 0 ? void 0 : _this$node$parent3.getComponent(_crd && Tornado === void 0 ? (_reportPossibleCrUseOfTornado({
                  error: Error()
                }), Tornado) : Tornado);
              ...
              case COLLIDER_NAME.FIRE_BALL_BIG:
                scriptSkillCollider = (_this$node$parent4 = this.node.parent) === null || _this$node$parent4 === void 0 ? void 0 : _this$node$parent4.getComponent(_crd && FireBallBig === void 0 ? (_reportPossibleCrUseOfFireBallBig({
                  error: Error()
              ...
              case COLLIDER_NAME.LASER:
                scriptSkillCollider = (_this$node$parent5 = this.node.parent) === null || _this$node$parent5 === void 0 ? void 0 : _this$node$parent5.getComponent(_crd && Laser === void 0 ? (_reportPossibleCrUseOfLaser({
                  error: Error()
                }), Laser) : Laser);
