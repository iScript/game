System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("MonsterBloodBar", MonsterBloodBar = (_dec = ccclass('MonsterBloodBar'), _dec2 = property(UITransformComponent), _dec3 = property(UITransformComponent), _dec4 = property(UITransformComponent), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        ...
        function MonsterBloodBar() {
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "UIComBloodBar", _descriptor3, _assertThisInitialized(_this));

          _defineProperty(_assertThisInitialized(_this), "_whiteBarHeight", 19);

          _defineProperty(_assertThisInitialized(_this), "_redBarHeight", 19);
          ...
          _defineProperty(_assertThisInitialized(_this), "_maxWhiteBarWidth", 104);

          _defineProperty(_assertThisInitialized(_this), "_maxRedBarWidth", 104);
          ...
          _defineProperty(_assertThisInitialized(_this), "_isStopMove", false);

          _defineProperty(_assertThisInitialized(_this), "_prevBloodPos", new Vec3());
