System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("SettlementPanel", SettlementPanel = (_dec = ccclass('SettlementPanel'), _dec2 = property(SpriteFrame), _dec3 = property(SpriteFrame), _dec4 = property(SpriteComponent), _dec5 = property(LabelComponent), _dec6 = property(Node), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        ...
        function SettlementPanel() {
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "sfTitleWin", _descriptor, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "sfTitleFail", _descriptor2, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "spTitle", _descriptor3, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "lbLevel", _descriptor4, _assertThisInitialized(_this));

          _initializerDefineProperty(_assertThisInitialized(_this), "ndSkillList", _descriptor5, _assertThisInitialized(_this));
        ...
        _proto.onBtnPlayAgainClick = function onBtnPlayAgainClick() {
          (_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
            error: Error()
          }), AudioManager) : AudioManager).instance.playSound((_crd && constant === void 0 ? (_reportPossibleCrUseOfconstant({
            error: Error()
      ...
      }(Component), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "sfTitleWin", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
