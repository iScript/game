System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("Main", Main = (_dec = ccclass('Main'), _dec2 = property(Node), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Component) {
        ...
        function Main() {
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "ndLoading", _descriptor, _assertThisInitialized(_this));
        ...
        _proto.start = function start() {
          ...
          (_crd && localConfig === void 0 ? (_reportPossibleCrUseOflocalConfig({
            error: Error()
          }), localConfig) : localConfig).instance.loadConfig(function () {
            _this2._loadFinish();
        ...
        _proto._loadFinish = function _loadFinish() {
        ...
        return Main;
      }(Component), _temp), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "ndLoading", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
