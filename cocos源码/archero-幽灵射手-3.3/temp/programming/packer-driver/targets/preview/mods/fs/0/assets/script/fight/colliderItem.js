    ...
    execute: function () {
      ...
      _export("ColliderItem", ColliderItem = (_dec = ccclass('ColliderItem'), _dec2 = property({
        ...
        function ColliderItem() {
          ...
          _defineProperty(_assertThisInitialized(_this), "_curHeartBigQuat", new Quat());
          ...
          if (otherCollider.getGroup() == (_crd && constant === void 0 ? (_reportPossibleCrUseOfconstant({
            ...
            switch (this.colliderName) {
              ...
              case COLLIDER_NAME.NPC_BUSINESS_MAN:
                ...
                if ((_crd && playerData === void 0 ? (_reportPossibleCrUseOfplayerData({
                  ...
                  (_crd && uiManager === void 0 ? (_reportPossibleCrUseOfuiManager({
                    error: Error()
                  }), uiManager) : uiManager).instance.showDialog("shop/shopPanel", [function () {
                    (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
                      error: Error()
                    }), GameManager) : GameManager).isGamePause = false;
                    (_crd && poolManager === void 0 ? (_reportPossibleCrUseOfpoolManager({
              ...
              case COLLIDER_NAME.NPC_WISE_MAN:
                ...
                if ((_crd && playerData === void 0 ? (_reportPossibleCrUseOfplayerData({
                  ...
                  (_crd && uiManager === void 0 ? (_reportPossibleCrUseOfuiManager({
                    error: Error()
                  }), uiManager) : uiManager).instance.showDialog("skill/skillPanel", [function () {
                    (_crd && poolManager === void 0 ? (_reportPossibleCrUseOfpoolManager({
                      error: Error()
                    }), poolManager) : poolManager).instance.putNode(_this2.node);
                    (_crd && GameManager === void 0 ? (_reportPossibleCrUseOfGameManager({
            ...
            switch (this.colliderName) {
              case COLLIDER_NAME.ARROW:
                var scriptArrow = this.node.getComponent(_crd && Arrow === void 0 ? (_reportPossibleCrUseOfArrow({
                  error: Error()
            ...
            switch (this.colliderName) {
              case COLLIDER_NAME.ARROW:
                ...
                var _scriptArrow = this.node.getComponent(_crd && Arrow === void 0 ? (_reportPossibleCrUseOfArrow({
                  error: Error()
                }), Arrow) : Arrow); //箭是否弹射
